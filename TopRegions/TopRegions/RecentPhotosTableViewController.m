...
- (void)updateTable {
    ...
    NSArray *recentPhotos = [RecentPhoto loadAllRecentPhotosInManagedObjectContext:self.managedObjectContext];
    for (RecentPhoto *recent in recentPhotos) {
        [photos addObject:recent.photo];
    }
