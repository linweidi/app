...
- (void)setPhotoDatabaseContext:(NSManagedObjectContext *)photoDatabaseContext
{
    ...
    NSDictionary *userInfo = self.photoDatabaseContext ? @{ RegionsDatabaseAvailableContext : self.photoDatabaseContext } : nil;
    [[NSNotificationCenter defaultCenter] postNotificationName:RegionsDatabaseAvailableNotification
                                                        object:self
                                                      userInfo:userInfo];
}
